    ...
    <header class="sticky top-0 bg-weather-primary shadow-lg">
        ...
        >
            ...
            <div class="flex gap-3 flex-1 justify-end">
                ...
                ></i>
                <i 
                    class="fa-solid fa-plus text-xl hover:text-weather-secondary 
            ...
            <BaseModal :modalActive="modalActive" @close-modal="toggleModal">
                <div class="text-black">
                    ...
                    <p class="mb-4">
                        The Local Wather allows you to track the current and future Weather
                        of cities of your choosing.
                    </p>
                    <h2 class="text-2xl">How it works:</h2>
                    <ol class="list-decimal list-inside mb-4">
                        <li>
                            Search for your city by entering the name of your city
                            in the search bar.
                        </li>
                        <li>
                            Track the city by clicking the plus icon in the top right.
                    ...
                    <p>
                        If you wish to no longer track a city, simply select the city
                        within the home page. At the bottom of the page, there will be
                        an to delete the city
                    </p>
                </div>
            </BaseModal>
